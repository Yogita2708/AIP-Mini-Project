...
public class AirportSelectionWindow extends JFrame {
    ...
    public AirportSelectionWindow() {
        ...
        BackgroundPanel backgroundPanel = new BackgroundPanel("airport.jpg"); // Path to your background image
    ...
    private Map<Integer, Map<Integer, Integer>> createRealAirportGraph() {
        ...
        int[][] distances = {
                ...
                {921,  712,   1158, 0,    1278, 1791, 789,  1552, 693,  4536},   // GAY
                {975,  1054,  1073, 1278, 0,    1047, 592,  933,  1462, 4532},   // AMD
                {2132, 2147,  2138, 1791, 1047, 0,    1346, 491,  2254, 3456},   // CCJ
